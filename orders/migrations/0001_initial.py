# Generated by Django 4.2.7 on 2024-03-17 18:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_total', models.FloatField(verbose_name=' تمام سفارشات')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(max_length=50, verbose_name=' اندازه')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='کاربر')),
                ('variation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.variation', verbose_name='واریانت')),
            ],
            options={
