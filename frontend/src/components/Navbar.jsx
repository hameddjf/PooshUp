    ...
    <nav className="md:hidden">
      ...
      <div className="fixed bottom-0 right-0 z-40 h-[64px] w-screen">
        <ul className="flex h-full items-center justify-between px-4 sm:p-8">
          <NavIcon action={() => setIsMenuOpen(!isMenuOpen)} icon={menu_icon} />
      ...
      {/* Menu */}
      <div
        className={`${isMenuOpen ? "translate-x-full" : "-translate-x-full"} fixed right-full top-0 z-40 h-screen w-screen 
         bg-white/50 backdrop-blur-md transition-all duration-500`}
      >
        <div className="p-4">
